...
system_prompt = Template("\n".join([
    ...
    ". عليك توليد رد بناء على المستندات المقدمة",
    ".تجاهل المستندات التي لا تتعلق باستفسار المستخدم",
    ".يمكنك الاعتدار للمستخدم إذا لم تتمكن من توليد رد",
    ". عليك توليد الرد بنفس لغة استفسار المستخدم",
    "·كن مؤدبا ومحترماً في التعامل مع المستخدم",
...
".بناء فقط على المستندات المذكورة أعلاه، برجى توليد إجابة للمستخدم",
"## السؤال:" ,
"$query",
"",
"## الإجابة:",
