...
async def upload_data(requst:Request, project_id: int, file:UploadFile ,
...
async def process_endpoint(requst:Request,project_id: int, process_request: ProcessRequest ):
