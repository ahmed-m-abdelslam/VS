...
async def index_and_push_data(request:Request, project_id: int, push_request:PushRequest):
...
async def get_project_indexed_info(request:Request, project_id: int):
...
async def search_indexed_data(request:Request, project_id: int, search_request:SearchRequest):
